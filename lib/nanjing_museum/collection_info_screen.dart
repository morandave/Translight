...
import 'package:best_flutter_ui_templates/nanjing_museum/collection_app_theme.dart';
            ...
            Column(
              children: <Widget>[
                AspectRatio(
                  aspectRatio: 1.2,
                  child: Image.network(
                    'https://moran-collection.obs.cn-north-4.myhuaweicloud.com/NanJingMuseum/images/'+ id +'.jpeg',
                    errorBuilder: (BuildContext context, Object exception, StackTrace? stackTrace) {
                      return Image.network('https://moran-collection.obs.cn-north-4.myhuaweicloud.com/NanJingMuseum/images/'+ id +'.png');
                    },
                  )
                  ,
                ),
